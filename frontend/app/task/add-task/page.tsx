...
export default function AddTaskPage() {
  ...
  const createTask = (event: any) => {
    ...
    callAPI(API.CREATE_TASK, { method: "POST", body: JSON.stringify(data)}).then(_ =>
  ...
  return (
    <div className="md:container md:mx-auto md:my-32">
      ...
      <p className="text-4xl text-gray-900 dark:text-white mb-6">Add a Task</p>
      <form onSubmit={(event) => createTask(event)}>
        ...
        <div className="flex items-start mb-6">
          <textarea value={formValues.description} onChange={(e) =>
